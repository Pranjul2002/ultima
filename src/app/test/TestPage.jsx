...
export default function TestPage() {
  ...
  if (isFinished) {
    ...
    const correctAnswers  = filteredQuestions.filter((q) => answers[q.id] === q.answer).length
    ...
    if (percentage >= 80) {
      ...
      suggestion = "You have strong conceptual clarity. Try increasing difficulty level."
    } else if (percentage >= 60) {
      message    = "Great Job! 👍"
      suggestion = "You're doing well. Review minor mistakes and aim higher next time."
    } else if (percentage >= 40) {
      message    = "Good Effort 💪"
      suggestion = "Revise the topic once and practice a few more problems."
    } else {
      message    = "Keep Going 🌱"
      suggestion = "Don't worry! Revisit fundamentals and try again. Progress takes practice."
    }
